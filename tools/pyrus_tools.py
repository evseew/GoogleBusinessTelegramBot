...
def create_pyrus_task(
    ...
    """
    logger.info(f"🎯 create_pyrus_task: branch='{branch_name}', message='{message_text[:50]}...'")
    ...
    if result.get("success"):
        return {
            ...
            "message": (
                ...
                f"Задача создана и взята в работу. "
...
PYRUS_FUNCTION_DESCRIPTION = (
    ...
    "1) Выясни суть обращения клиента, "
    "2) Уточни филиал, "
    "3) Сформулируй итоговое сообщение, "
    "4) Получи подтверждение от клиента ('да', 'верно', 'передайте')."
)
    ...
    "properties": {
        ...
        "client_name": {
            ...
            "description": (
                ...
                "Укажи, если клиент назвал своё имя в диалоге."
            )
        },
        "client_phone": {
            "type": "string",
            "description": (
                ...
                "Укажи, если клиент предоставил номер телефона."
            )
        },
        "student_name": {
            "type": "string",
            "description": (
                ...
                "Укажи, если клиент назвал имя ребёнка."
            )
        },
        "group_number": {
            "type": "integer",
            "description": (
                ...
                "Укажи, если клиент знает номер группы."
            )
        }
    },
